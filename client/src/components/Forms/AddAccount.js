...
export default function AddAccount() {
  ...
  const handleSubmit = (e) => {
    ...
    if (!formData.initialBalance) {
      validationErrors.initialBalance = 'Please Add Initial Balance'
    } else if (formData.initialBalance == '0') {
      validationErrors.initialBalance = 'Initial Balance should be greater than 0'
    }
              ...
              <div>
                ...
                <div className="mt-1">
                  <input
                    ...
                    className="block w-full appearance-none rounded-md border border-gray-300 px-3 py-2 placeholder-gray-400 shadow-sm focus:border-indigo-500 focus:outline-none focus:ring-indigo-500 sm:text-sm"
                  />
                  {errors.initialBalance && <span style={{ color: 'red' }}>{errors.initialBalance}</span>}
                </div>
              </div>
