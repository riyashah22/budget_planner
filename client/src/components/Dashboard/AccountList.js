              ...
              <>
                ...
                <div className="max-w-4xl mx-auto mb-12 text-center">
                  ...
                  <p className="text-lg md:text-xl text-coolGray-500 font-medium">
                    "Access a comprehensive overview of your financial health at a glance with our intuitive and informative dashboard. Monitor account balances, transactions, budgets, and goals seamlessly, empowering you to make informed decisions and take control of your financial future."
                  </p>
                  <Link
