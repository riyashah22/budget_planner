          ...
          <div className="flex flex-wrap lg:items-center -mx-4">
            ...
            <div className="w-full md:w-1/2 px-4">
              <div className="relative mx-auto md:mr-0 max-w-max">
                <img
                  src="https://img.freepik.com/premium-vector/budget-business-planning-financial-planning-flat-vector-illustration-banner-landing-page_128772-1074.jpg"
                  alt="home"
                />
              </div>
            </div>
        ...
        <div className="relative container px-4 mx-auto">
          <div className="xl:max-w-4xl mb-18 md:mb-16 mx-auto text-center">
            ...
            <p className="mb-6 text-lg md:text-xl text-coolGray-500 font-heading">
              Track your earnings and spending effortlessly, saving you both time and money with our intuitive Income and Expenses Tracker.
            </p>
            <Link to={'/register'}
          ...
          {/* <div className="relative max-w-4xl mx-auto">
            <img
              className="relative"
              src="https://pixabay.com/get/ga1211e4690ed7ed95f0198680f98bdeaf9ad49d91dc0eab1716db4660a574d0d0c324edf5e0f4c3862a88c27ae382393.png"
              alt="landing"
            />
          </div> */}
        </div>
